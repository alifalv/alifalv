...
/**
 * 抽象定义业务缓存统一接口;用以隔离具体缓存机制，其实现类可以采用redis, memercache服务器来实现，也可以自实现；
 * </br>创建时间：2015-3-19
 * 
 * @author hyq
 */
...
public interface ICache {
	...
	public final static Map<String, String> tokenMap = new HashMap<String, String>();
	/**
	 * 根据key取得对应的值对象；
	 * 
	 * @param key
	 ...
	 *            放多长时间，单位:ms
	 */
	void put(Serializable key, String fieldName, Object value, long timeLength)
			throws Exception;
