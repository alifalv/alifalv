...
public class SystemConfigUtil {
	...
	//发文省份
	public static List<Unit> unitAddressList = new ArrayList<Unit>();
	public static Map<String, Unit> unitAddressMap = new HashMap<String, Unit>();
	...
	public final static String TYPE_EXPERIENCE = "experience";
	public final static String TYPE_SAL = "sal";
	public final static String TYPE_UNIT_ADDRESS = "unitAddress";
	...
	public static String getValue(int id,String type){
		...
		}else if(type.equals(TYPE_EXPERIENCE)) {
			value = experienceMap.get(TYPE_EXPERIENCE+id).getExperienceName();
		}else if(type.equals(TYPE_SAL)) {
			value = salMap.get(TYPE_SAL+id).getSalName();
		}else if(type.equals(TYPE_UNIT_ADDRESS)) {
			value = unitAddressMap.get(TYPE_UNIT_ADDRESS+id).getUnitName();
		}
	...
	public static void main(String[] args){
		/*System.out.println(getValue(9, TYPE_EXPERIENCE));
		System.out.println(getValue(2, TYPE_SAL));
		System.out.println(getValue(2, TYPE_JOB));*/
		
		//System.out.println(getValue(4, TYPE_UNIT));
		for(int i=1;i<35;i++){
			System.out.println(i+":"+getValue(i, TYPE_UNIT_ADDRESS));
	...
	private static void loadLevelInfo() throws Exception{
		...
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/level.xml"));
	...
	private static void loadDriverInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/driver.xml"));
	...
	private static void loadJobInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/job.xml"));
	...
	private static void loadCaseInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/caseType.xml"));
	...
	private static void loadDeclareInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/declare.xml"));
	...
	private static void loadSalInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/sal.xml"));
		Element root = doc.getRootElement();
	...
	private static void loadEducationInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/education.xml"));
		Element root = doc.getRootElement();
	...
	private static void loadExperienceInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/experience.xml"));
		Element root = doc.getRootElement();
	...
	private static void loadUnitInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/unit.xml"));
		Element root = doc.getRootElement();
	...
	private static void loadUnitAddressInfo() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/unitAddress.xml"));
		Element root = doc.getRootElement();
		List<Element> sals = root.elements("unit");
		for (Element l : sals ) {
			Unit c = new Unit();
			c.setUnitId(Integer.parseInt(l.elementText("unitId")));
			c.setUnitName(l.elementText("unitName"));
			unitAddressMap.put("unitAddress"+c.getUnitId(), c);
			unitAddressList.add(c);
		}
	}
	...
	private static void loadEffectivenessGrade() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/effectivenessGrade.xml"));
		Element root = doc.getRootElement();
	...
	private static void loadAddress() throws Exception{
		SAXReader saxReader = new SAXReader(); 
		Document doc = saxReader.read(SystemConfigController.class.getClassLoader().getResourceAsStream("com/legal/app/controller/config/address.xml"));
		Element root = doc.getRootElement();
