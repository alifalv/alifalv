...
public class LunarUtil {
	 private int year;
	     ...
	     */
	    public LunarUtil(Calendar cal) throws java.text.ParseException {
	 ...
	 /*       Date date = new Date();
	       ...
	       // String d = dateFormat.format("2018-10-6 10:11");
	        ...
	        System.out.println("北京时间：" + chineseDateFormat.format(today.getTime())
	                + "　农历" + lunar);*/
	        String d = "2018-10-9 10:11";
	        System.out.println("北京时间：" + getLunarDate(d));

	    }
	    
	   public static String getLunarDate(String date) throws Exception{
		   Calendar today = Calendar.getInstance();
