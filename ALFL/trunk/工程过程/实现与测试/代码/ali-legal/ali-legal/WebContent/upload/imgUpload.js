    ...
    ;(function ($) {
        ...
        $.fn.extend({
            takungaeImgup: function (opt, serverCallBack) {
                ...
                if(opt.imgUrl) {
                    ...
                    $img.attr("src", utils.createImgUrl(imgArr[0]));
                ...
                $(this).change(function () {
                    ...
                    if (fileList.length > imageNum || totalNum > imageNum) {
                        alert('上传图片数目不可以超过' + imageNum +'个，请重新选择'); // 一次选择上传超过5个
                ...
                function uploadImg(opt, file, obj) {
                    ...
                    ImgToBase64(file,1, function(base64img) {
                        $.ajax({
                        		type:"POST",
                            url: requestUrl_pc+'api/file/uploadImg',
                            data: {
        ...
        function ImgToBase64(file, maxLen, callBack) {
            ...
            img.onload = function () {
                ...
                var base64 = canvas.toDataURL('image/jpeg', 1);//0.9

                // var image_base64 = base64.replace("data:image/jpeg;base64,","");
                callBack(base64);
            };
