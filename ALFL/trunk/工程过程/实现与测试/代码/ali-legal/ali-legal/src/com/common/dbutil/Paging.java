 ...
 * @author yuqing
 */
public class Paging extends ArrayList<Object> implements Serializable {
	...
	/*
	 * 是否需要底层生成总成数据条数 2014-05-17 HYQ
	 * 解决这样的问题：那些复杂的SQL,DBUTIL无法为之计算总行数时，用户可以定义该值为false, 以告知DBUTIL无需为之计算总行数
	 */
	 ...
	 * @param pageNo
	 *            当前页号，从1开始；
	 * @param generateTotalCount
	 *            是否需要自动查询出总行数;
	 */
	public Paging(Integer pageSize, Integer pageNo, boolean generateTotalCount) {
		super();
		this.pageSize = (null == pageSize) ? this.pageSize : pageSize.intValue();
		this.pageNo = (null == pageNo) ? this.pageNo : pageNo.intValue();
	...
	public int getTotalPage() {
		...
		int pages = (this.totalCount+this.pageSize-1)/this.pageSize;
