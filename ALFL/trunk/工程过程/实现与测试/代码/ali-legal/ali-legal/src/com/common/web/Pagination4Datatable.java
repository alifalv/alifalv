...
public class Pagination4Datatable {
	 ...
	 * @return Pagination4Datatable
	 */
	public static Pagination4Datatable getInstanceMap(List<Map<String,Object>> list, Integer totalCount, String sEcho){
		Paging paging = new Paging();
		paging.setListMap(list);
		paging.setRowCount(totalCount);
	 ...
	 * @return Pagination4Datatable
	 */
	public static Pagination4Datatable getInstanceMap(Paging pagination, String sEcho){
		return new Pagination4Datatable(pagination, sEcho);
	}
	 ...
	 */
	public Pagination4Datatable(Paging pagination, String sEcho){
		this.setsEcho(sEcho);
		...
		if( pagination.getList() == null){
			this.setAaData(pagination.getListMap());
		}else{
