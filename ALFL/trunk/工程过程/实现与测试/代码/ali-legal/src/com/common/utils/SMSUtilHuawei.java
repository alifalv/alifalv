...
public class SMSUtilHuawei {
	...
	private static String sender = "csms18071304	";
	 ...
	 * @throws Exception
	 */
	public static boolean send(String tel, String templateId, String templateParas) throws Exception {
		...
		String body = buildRequestBody(sender, tel, templateId, templateParas, statusCallBack);
	...
	public static void main(String[] args) throws Exception{
		// 请从模板管理页面获取模板ID进行替换
		String templateId = "6efd4b3e29324f08ac10122372a9edb5";
		boolean rs=SMSUtilHuawei.send("13378017839,17375804185", templateId, "[\"1234\"]");
