...
define(function(require,exports,module) {
    ...
    Pagination.prototype.refreshHtml = function(){
        ...
        //上一页
        html = html + '<li><a href="javascript:void(0);" class="j-previous">上一页</a></li>';
        ...
        if(_that.options.totalPage <= _that.options.scopePage) {
            ...
            if(startIndex + 1 > flag) {
                html = html + '<li><a href="javascript:void(0);">...</a></li>';
            }
        ...
        //下一页
        html = html + '<li><a href="javascript:void(0);" class="j-next">下一页</a></li>';

        //尾页
        html = html + '<li><a href="javascript:void(0);" class="j-last">尾页</a></li>';

        _$pagination.append(html)
    };

    Pagination.prototype.initHtml = function() {
        this.$pageElement.html('<div class="ui-inline-block"><div class="ui-page">第<span class="j-currentPage">1</span>页/共<span class="j-totalPage">1</span>页</div></div>' +
       '<ul class="pagination"></ul>' +
       '<div class="ui-inline-block ui-width-170">' +
       '    <div class="input-group">' +
       '        <input type="text" class="form-control j-goPage" placeholder="输入指定页码">' +
       '        <span class="input-group-btn"><a class="btn btn-default ui-btn-lightblue j-go" href="javascript:void(0);" type="button">搜索</a></span>' +
       '    </div>' +
       '</div>');
    };
