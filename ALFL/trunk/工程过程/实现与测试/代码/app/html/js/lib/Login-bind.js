...
created(){
	 // alert(1)
	 var opid = JSON.parse(localStorage.openId)
	 var opty = JSON.parse(localStorage.optype)
	 this.openId = opid.data
	 this.openType = opty.data
	 // alert(this.openId )
},
	methods:{
		// 登录验证
...
// 			debugger
            ...
            rest.post({
                ...
                success: function (result) {
					// debugger
					// alert(JSON.stringify(result.data.userId))
