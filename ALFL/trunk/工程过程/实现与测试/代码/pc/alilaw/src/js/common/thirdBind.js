...
define(function(require,exports,module) {
    ...
    function bindThreeLoginFlag(openId, openType) {
    ...
    //微信登录
    $(document).on('click','[thirdbind="wx"]', function() {
        layer.open({
            type: 1,
            title : '微信扫一扫',
            area: ['300px', '450px'], //宽高
    ...
    //新浪登录
    $(document).on('click', '[thirdbind="sina"]', function() {
                        ...
                        if (bStatus) {
                            W.parseCMD('/users/show.json', function (oResult2, bStatus) {//通过uid获取用户信息
                                if (bStatus) {
                                    ...
                                    bindThreeLoginFlag(args.openid, constants.openType.sina);
    ...
    //QQ登录
    $(document).on('click', '[thirdbind="qq"]', function() {
