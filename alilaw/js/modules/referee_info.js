...
define(function(require, exports, module) {
        ...
        rest.post({
            ...
            success: function(result) {
                ...
                C.template('#activeTmpl').renderReplace(result, function($html) {
                    initShareBox();
                    initReplyList(authorUserId);

                    // require('viewer');
                    // var viewer = new Viewer(document.getElementById('img_viewer'));

                    // var viewer2 = new Viewer(document.getElementById('img_viewer2'));
    ...
    /**
     * 发布留言
     * 【百姓吐槽详情、阿里裁判详情 】律师对发布人的回帖
     * 【百姓吐槽详情、阿里裁判详情、案源详情、法律咨询详情】发布人对律师的回贴
     * @param $form
     */
    ...
    function initReplyList(authorUserId) {
        ...
        C.template('#replyBoxTmpl').load(firstReplyBoxData, $firstReplybox, function() {
            ...
            login_form_valid.on('valid.form', function(e, form) {
                var loginUserInfo = utils.getLoginUserInfo(true);
                commonReply($(form), authorUserId, function() {
